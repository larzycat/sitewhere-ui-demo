<template>
  ...
  >
    ...
    <template slot="tabs">
      <v-tab key="microservices">微服务</v-tab>
    </template>
    ...
    <template slot="actions">
      <sw-navigation-action-button icon="edit" tooltip="编辑租户" @action="onEdit" />
      <sw-navigation-action-button icon="times" tooltip="删除租户" @action="onDelete" />
    </template>
