<template>
  ...
  >
    ...
    <template slot="tabs">
      <v-tab key="assignments">作业</v-tab>
    </template>
    ...
    <template slot="actions">
      <sw-navigation-action-button icon="edit" tooltip="编辑设备" @action="onEdit"/>
      <sw-navigation-action-button icon="times" tooltip="删除设备" @action="onDelete"/>
    </template>
  </sw-detail-page>
</template>
