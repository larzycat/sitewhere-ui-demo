<template>
  ...
  >
    ...
    <template slot="tabs">
      <v-tab key="elements">元素组</v-tab>
    </template>
    <template slot="tab-items">
      <device-group-elements tabkey="elements" ref="list" :deviceGroup="deviceGroup" />
    </template>
    <template slot="actions">
      <add-button tooltip="添加组元素" @action="onAddGroupElement" />
      <edit-button tooltip="编辑设备组" @action="onEdit" />
      <delete-button tooltip="删除设备组" @action="onDelete" />
    </template>
