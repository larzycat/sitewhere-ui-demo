<template>
  ...
  >
    ...
    <template slot="actions">
      <edit-button tooltip="编辑站点类型" @action="onEdit"/>
      <delete-button tooltip="删除站点类型" @action="onDelete"/>
    </template>
  </sw-detail-page>
</template>
...
export default class AreaTypeDetail extends DetailComponent<IAreaType> {
  ...
  afterRecordLoaded(areaType: IAreaType) {
    var section: INavigationSection = {
      ...
      longTitle: "管理站点类型: " + areaType.name
    };
