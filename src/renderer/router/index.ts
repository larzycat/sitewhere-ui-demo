...
//边缘计算
import EdgeComputingBanner from "@/components/edgecomputing/EdgeComputingBanner.vue";
import ObjectModelList from "@/components/edgecomputing/objectmodel/ObjectModelList.vue";
import ObjectComputingList from "@/components/edgecomputing/objectcomputing/ObjectComputingList.vue";
import ObjectComputeCreate from "@/components/edgecomputing/objectcomputing/ObjectComputeCreate.vue";
import ObjectVisualizationList from "@/components/edgecomputing/objectvisualization/ObjectVisualizationList.vue";
import ObjectModelDetail from "@/components/edgecomputing/objectmodel/ObjectModelDetail.vue";
import ObjectModelAdd from "@/components/edgecomputing/objectmodel/ObjectModelAdd.vue";
import ObjectComputingCreate from "@/components/edgecomputing/objectcomputing/ObjectComputingCreate.vue";
...
const routes = <Array<RouteConfig>>[
  ...
  },
  {
    ...
    children: [
	  ...
	  {
        path: "edgeCompute",
        component: EdgeComputingBanner
      },
      {
        path: "objectModel",
        component: ObjectModelList
      },
      {
        path: "objectModel/:token",
        component: ObjectModelDetail
	  },
      {
        path: "toObjectModelAdd",
        component: ObjectModelAdd
      },
	  {
        path: "objectCompute",
        component: ObjectComputingList
	  },
	  {
        path: "objectCompute/:token",
        component: ObjectComputingList
	  },
	  {
        path: "objectComputeCreate",
        component: ObjectComputeCreate
      },
      {
        path: "objectComputeCreate/:token",
        component: ObjectComputeCreate
      },
      {
        path: "objectComputingCreate",
        component: ObjectComputingCreate
      },
      {
        path: "objectView",
        component: ObjectVisualizationList
      },
      {
        path: "objectView/:token",
        component: ObjectVisualizationList
      },
      {
        path: "batch",
